<?php
    ...
    else
    {
        ...
        $hotelName = $_POST['txtSupplierName'];
        $description = $_POST['txtDescription'];
        $stars = $_POST['txtStar'];
        $days = $_POST['txtDays'];
        $night = $_POST['txtNight'];
        ...
        $titleN = $_POST['titleN'];
        $forenameN = $_POST['forenameN'];
        $surnameN = $_POST['surnameN'];
        ...
        $xml_request = '<?xml version="1.0"?>'
            ...
            .'<NewBookingInfo>'
            .'<Name>'.$titleN.' '.$forenameN.' '.$surnameN.'</Name>'
            .'<QB>B</QB>'
            .'</NewBookingInfo>'
            .'<Opt>'.$Opt.'</Opt>'
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <div class="footer-grid">
                                    ...
                                    <?php $_SESSION['bookingID'] = $serviceProduct->BookingId; ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-10">
                                                    <?php echo $titleN.' '.$forenameN.' '.$surnameN; ?>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-12">

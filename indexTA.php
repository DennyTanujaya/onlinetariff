            ...
            <div class="col-md-12  ">
                <div class="sap_tabs">
                    <div class="booking-info about-booking-info">
                        <h2>Arrival Transfer</h2>
                    </div>
                    <form method="POST" action="bookTransfer.php">
                                                        ...
                                                        <div class="book_date">
                                                                ...
                                                                <option selected disabled>Choose Destination</option>              
                                                                    <?php
                                                                        ...
                                                                        {
                                                                            if($valueSupplierAnalysis2[$i] == 'TA' OR $valueSupplierAnalysis2[$i] == 'PF')
                                                                            {
        ...
        <section id="hot-tours" class="section-gray">
            <div class="image-zoom-container">
                <div class="zoom-container">
                    <a href="product.php?key=MED&type=TA">
                ...
                <div class="zoom-container">
                    <a href="product.php?key=DPS&type=TA">
                    <span class="zoom-caption">
                                    <h3>Bali</h3>
                ...
                <div class="zoom-container">
                    <a href="product.php?key=NTT&type=TA">
                    <span class="zoom-caption">
                                    <h3>Flores</h3>
                ...
                <div class="zoom-container">
                    <a href="product.php?key=CGK&type=TA">
                    <span class="zoom-caption">
                                    <h3>Jakarta</h3>
                                    <p>Metropolis City</p>
                                    <div >READ MORE</div>
                ...
                <div class="zoom-container">
                    <a href="product.php?key=KAL&type=TA">
                    <span class="zoom-caption">
                                    <h3>Kalimantan</h3>
                ...
                <div class="zoom-container">
                    <a href="product.php?key=SUM&type=TA">
                    <span class="zoom-caption">
                                    <h3>Sumatra</h3>

            ...
            <div class="nav-top">
                <div class="top-nav">
                    ...
                    <ul class="nav1">
                        ...
                        <li><a href="#">Golf</a></li>
                        <li class="active"><a href="indexTP.php">Ground Transport</a></li>
                                                        ...
                                                        <div class="book_date">
                                                                ...
                                                                <option selected disabled>Choose Destination</option>              
                                                                    <?php
                                                                        ...
                                                                        {
                                                                            if($valueSupplierAnalysis2[$i] == 'PB' OR $valueSupplierAnalysis2[$i] == 'PJ' OR $valueSupplierAnalysis2[$i] == 'PY' OR $valueSupplierAnalysis2[$i] == 'PN' OR $valueSupplierAnalysis2[$i] == 'PL' OR $valueSupplierAnalysis2[$i] == 'PK' OR $valueSupplierAnalysis2[$i] == 'PM' OR $valueSupplierAnalysis2[$i] == 'FB' OR $valueSupplierAnalysis2[$i] == 'FJ' OR $valueSupplierAnalysis2[$i] == 'FY' OR $valueSupplierAnalysis2[$i] == 'FN' OR $valueSupplierAnalysis2[$i] == 'FL' OR $valueSupplierAnalysis2[$i] == 'FK' OR $valueSupplierAnalysis2[$i] == 'FM')
                                                                            {
        ...
        <section id="hot-tours" class="section-gray">
            <div class="image-zoom-container">
                <div class="zoom-container">
                    <a href="product.php?key=MED&type=TP">
                ...
                <div class="zoom-container">
                    <a href="product.php?key=DPS&type=TP">
                    <span class="zoom-caption">
                                    <h3>Bali</h3>
                ...
                <div class="zoom-container">
                    <a href="product.php?key=NTT&type=TP">
                    <span class="zoom-caption">
                                    <h3>Flores</h3>
                ...
                <div class="zoom-container">
                    <a href="product.php?key=CGK&type=TP">
                    <span class="zoom-caption">
                                    <h3>Jakarta</h3>
                                    <p>Metropolis City</p>
                                    <div >READ MORE</div>
                ...
                <div class="zoom-container">
                    <a href="product.php?key=KAL&type=TP">
                    <span class="zoom-caption">
                                    <h3>Kalimantan</h3>
                ...
                <div class="zoom-container">
                    <a href="product.php?key=SUM&type=TP">
                    <span class="zoom-caption">
                                    <h3>Sumatra</h3>
